...
// issuing, receiving, verifying cheques in etsc; (auto)cashing cheques in etsc
// as well as (auto)depositing etsc to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/ETSC3259/etsc/contracts/chequebook/contract"
	"github.com/ETSC3259/etsc/core/types"
	"github.com/ETSC3259/etsc/crypto"
	"github.com/ETSC3259/etsc/log"
	"github.com/ETSC3259/etsc/swarm/services/swap/swap"
)
...
// * depositing etsc to the chequebook
// * watching incoming etsc
