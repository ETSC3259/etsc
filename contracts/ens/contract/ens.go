...
// DeployENS deploys a new etsc contract, binding an instance of ENS to it.
...
// ENS is an auto generated Go binding around an etsc contract.
type ENS struct {
...
// ENSCaller is an auto generated read-only Go binding around an etsc contract.
type ENSCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSTransactor is an auto generated write-only Go binding around an etsc contract.
type ENSTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSFilterer is an auto generated log filtering Go binding around an etsc contract events.
type ENSFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSSession is an auto generated Go binding around an etsc contract,
...
// ENSCallerSession is an auto generated read-only Go binding around an etsc contract,
...
// ENSTransactorSession is an auto generated write-only Go binding around an etsc contract,
...
// ENSRaw is an auto generated low-level Go binding around an etsc contract.
type ENSRaw struct {
	Contract *ENS // Generic contract binding to access the raw methods on
}

// ENSCallerRaw is an auto generated low-level read-only Go binding around an etsc contract.
type ENSCallerRaw struct {
	Contract *ENSCaller // Generic read-only contract binding to access the raw methods on
}

// ENSTransactorRaw is an auto generated low-level write-only Go binding around an etsc contract.
