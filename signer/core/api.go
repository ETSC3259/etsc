...
import (
	...
	"github.com/ETSC3259/etsc/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*etscapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx etscapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*etscapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := etscapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
