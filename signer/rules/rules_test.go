...
import (
	...
	"github.com/ETSC3259/etsc/signer/core"
	"github.com/ETSC3259/etsc/signer/storage"
)
...
func (alwaysDenyUI) OnApprovedTx(tx etscapi.SignTransactionResult) {
	panic("implement me")
}
...
func (d *dummyUI) OnApprovedTx(tx etscapi.SignTransactionResult) {
...
func TestForwarding(t *testing.T) {
	...
	r.OnApprovedTx(etscapi.SignTransactionResult{})
...
func TestLimitWindow(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		...
		response := etscapi.SignTransactionResult{
			Tx:  dummySigned(v),
...
func (d *dontCallMe) OnApprovedTx(tx etscapi.SignTransactionResult) {
	d.t.Fatalf("Did not expect next-handler to be called")
}
