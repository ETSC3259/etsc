...
var (
	...
	etschashChainConfig *params.ChainConfig
...
func init() {
	...
	etschashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setEtscbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockEtschash(t *testing.T) {
	testPendingStateAndBlock(t, etschashChainConfig, etschash.NewFaker())
}
func TestPendingStateAndBlockClique(t *testing.T) {
	testPendingStateAndBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, etscdb.NewMemDatabase()))
}
...
func TestEmptyWorkEtschash(t *testing.T) {
	testEmptyWork(t, etschashChainConfig, etschash.NewFaker())
}
func TestEmptyWorkClique(t *testing.T) {
	testEmptyWork(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, etscdb.NewMemDatabase()))
}
...
func TestStreamUncleBlock(t *testing.T) {
	etschash := etschash.NewFaker()
	defer etschash.Close()

	w, b := newTestWorker(t, etschashChainConfig, etschash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockEtschash(t *testing.T) {
	testRegenerateMiningBlock(t, etschashChainConfig, etschash.NewFaker())
}

func TestRegenerateMiningBlockClique(t *testing.T) {
	testRegenerateMiningBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, etscdb.NewMemDatabase()))
}
...
func TestAdjustIntervalEtschash(t *testing.T) {
	testAdjustInterval(t, etschashChainConfig, etschash.NewFaker())
}

func TestAdjustIntervalClique(t *testing.T) {
	testAdjustInterval(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, etscdb.NewMemDatabase()))
}
