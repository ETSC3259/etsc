...
// Package tests implements execution of etsc JSON tests.
package tests
...
/* See https://github.com/etsc/tests/wiki/Blockchain-Tests-II

   Whetsc a block is valid or not is a bit subtle, it's defined by presence of
