...
// See https://github.com/etsc/EIPs/issues/176 for the test format specification.
...
func (t *StateTest) Run(subtest StateSubtest, vmconfig vm.Config) (*state.StateDB, error) {
	...
	statedb := MakePreState(etscdb.NewMemDatabase(), t.json.Pre)
	...
	context.getscash = vmTestBlockHash
...
func MakePreState(db etscdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/etsc/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
