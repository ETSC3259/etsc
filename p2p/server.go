...
// Package p2p implements the etsc p2p network protocols.
package p2p
...
import (
	...
	"github.com/ETSC3259/etsc/p2p/discover"
	"github.com/ETSC3259/etsc/p2p/discv5"
	"github.com/ETSC3259/etsc/p2p/enode"
	"github.com/ETSC3259/etsc/p2p/enr"
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.NAT != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "etsc discovery")
		}
	}
...
func (srv *Server) setupListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "etsc p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // etsc Node Record
