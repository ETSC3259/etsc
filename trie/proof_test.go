...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *etscdb.MemDatabase {
	var provers []func(key []byte) *etscdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *etscdb.MemDatabase {
		proof := etscdb.NewMemDatabase()
