...
type Database struct {
	diskdb etscdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb etscdb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch etscdb.Batch) error {
