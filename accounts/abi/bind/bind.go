...
// Package bind generates etsc contract Go bindings.
//
// Detailed usage document and tutorial available on the go-etsc Wiki page:
// https://github.com/ETSC3259/etsc/wiki/Native-DApps:-Go-bindings-to-etsc-contracts
package bind
