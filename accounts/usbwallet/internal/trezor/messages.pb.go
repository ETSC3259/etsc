...
const (
	...
	MessageType_MessageType_etscGetAddress       MessageType = 56
	MessageType_MessageType_etscAddress          MessageType = 57
	MessageType_MessageType_etscSignTx           MessageType = 58
	MessageType_MessageType_etscTxRequest        MessageType = 59
	MessageType_MessageType_etscTxAck            MessageType = 60
	...
	MessageType_MessageType_etscSignMessage      MessageType = 64
	MessageType_MessageType_etscVerifyMessage    MessageType = 65
	MessageType_MessageType_etscMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_etscGetAddress",
	57:  "MessageType_etscAddress",
	58:  "MessageType_etscSignTx",
	59:  "MessageType_etscTxRequest",
	60:  "MessageType_etscTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_etscSignMessage",
	65:  "MessageType_etscVerifyMessage",
	66:  "MessageType_etscMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_etscGetAddress":       56,
	"MessageType_etscAddress":          57,
	"MessageType_etscSignTx":           58,
	"MessageType_etscTxRequest":        59,
	"MessageType_etscTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_etscSignMessage":      64,
	"MessageType_etscVerifyMessage":    65,
	"MessageType_etscMessageSignature": 66,
...
func (m *ApplySettings) getscomescreen() []byte {
	if m != nil {
		return m.Homescreen
	}
	return nil
...
// *
// Request: Ask device for etsc address corresponding to address_n path
// @next PassphraseRequest
// @next etscAddress
// @next Failure
type etscGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *etscGetAddress) Reset()                    { *m = etscGetAddress{} }
func (m *etscGetAddress) String() string            { return proto.CompactTextString(m) }
func (*etscGetAddress) ProtoMessage()               {}
func (*etscGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *etscGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *etscGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an etsc address derived from device private seed
// @prev etscGetAddress
type etscAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *etscAddress) Reset()                    { *m = etscAddress{} }
func (m *etscAddress) String() string            { return proto.CompactTextString(m) }
func (*etscAddress) ProtoMessage()               {}
func (*etscAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *etscAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EncryptedMessage) getscmac() []byte {
	if m != nil {
		return m.Hmac
	}
	return nil
...
func (m *DecryptMessage) getscmac() []byte {
	if m != nil {
		return m.Hmac
	}
	return nil
...
func (m *etscSignTx) Reset()                    { *m = etscSignTx{} }
func (m *etscSignTx) String() string            { return proto.CompactTextString(m) }
func (*etscSignTx) ProtoMessage()               {}
func (*etscSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *etscSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *etscSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *etscSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *etscSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *etscSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *etscSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *etscSignTx) GetDataLength() uint32 {
...
func (m *etscSignTx) GetChainId() uint32 {
...
func (m *etscTxRequest) Reset()                    { *m = etscTxRequest{} }
func (m *etscTxRequest) String() string            { return proto.CompactTextString(m) }
func (*etscTxRequest) ProtoMessage()               {}
func (*etscTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *etscTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *etscTxRequest) GetSignatureV() uint32 {
...
func (m *etscTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *etscTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev etscTxRequest
// @next etscTxRequest
type etscTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *etscTxAck) Reset()                    { *m = etscTxAck{} }
func (m *etscTxAck) String() string            { return proto.CompactTextString(m) }
func (*etscTxAck) ProtoMessage()               {}
func (*etscTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *etscTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next etscMessageSignature
// @next Failure
type etscSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *etscSignMessage) Reset()                    { *m = etscSignMessage{} }
func (m *etscSignMessage) String() string            { return proto.CompactTextString(m) }
func (*etscSignMessage) ProtoMessage()               {}
func (*etscSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *etscSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *etscSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *etscVerifyMessage) Reset()                    { *m = etscVerifyMessage{} }
func (m *etscVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*etscVerifyMessage) ProtoMessage()               {}
func (*etscVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *etscVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *etscVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *etscVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev etscSignMessage
type etscMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *etscMessageSignature) Reset()                    { *m = etscMessageSignature{} }
func (m *etscMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*etscMessageSignature) ProtoMessage()               {}
func (*etscMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *etscMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *etscMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *FirmwareUpload) getscash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*etscGetAddress)(nil), "etscGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*etscAddress)(nil), "etscAddress")
	...
	proto.RegisterType((*etscSignTx)(nil), "etscSignTx")
	proto.RegisterType((*etscTxRequest)(nil), "etscTxRequest")
	proto.RegisterType((*etscTxAck)(nil), "etscTxAck")
	proto.RegisterType((*etscSignMessage)(nil), "etscSignMessage")
	proto.RegisterType((*etscVerifyMessage)(nil), "etscVerifyMessage")
	proto.RegisterType((*etscMessageSignature)(nil), "etscMessageSignature")
