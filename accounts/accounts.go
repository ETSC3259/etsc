...
// Package accounts implements high level etsc account management.
package accounts
...
// Account represents an etsc account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // etsc account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain etsc.ChainStateReader)
