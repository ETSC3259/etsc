...
// See https://github.com/etsc/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whetsc the event notification loop is running
...
// ImportPreSaleKey decrypts the given etsc presale wallet and stores
