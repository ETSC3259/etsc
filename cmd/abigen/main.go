...
import (
	...
	"github.com/ETSC3259/etsc/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the etsc contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the etsc contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the etsc contract Solidity source to build and bind")
