...
import (
	...
	"github.com/ETSC3259/etsc/swarm"
	bzzapi "github.com/ETSC3259/etsc/swarm/api"
	swarmmetrics "github.com/ETSC3259/etsc/swarm/metrics"
...
// This init function sets defaults so cmd/swarm can run alongside getsc.
func init() {
...
var app = utils.NewApp("", "etsc Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-etsc Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//getsc only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for getsc and swarm
	...
	//register BZZ as node.Service in the etsc node
