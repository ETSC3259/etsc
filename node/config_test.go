...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "getsc.ipc", false, filepath.Join(os.TempDir(), "getsc.ipc")},
		{"data", "getsc.ipc", false, "data/getsc.ipc"},
		{"data", "./getsc.ipc", false, "./getsc.ipc"},
		{"data", "/getsc.ipc", false, "/getsc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "getsc.ipc", true, `\\.\pipe\getsc.ipc`},
		{"data", "getsc.ipc", true, `\\.\pipe\getsc.ipc`},
		{"data", `\\.\pipe\getsc.ipc`, true, `\\.\pipe\getsc.ipc`},
	}
