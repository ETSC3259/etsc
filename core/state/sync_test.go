...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(etscdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db etscdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db etscdb.Database, root common.Hash) error {
...
func checkStateConsistency(db etscdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, etscdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(etscdb.Database), srcRoot)
