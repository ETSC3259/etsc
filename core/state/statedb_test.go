...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := etscdb.NewMemDatabase()
	finalDb := etscdb.NewMemDatabase()
...
// https://github.com/ETSC3259/etsc/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(etscdb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(etscdb.NewMemDatabase()))
...
// See https://github.com/ETSC3259/etsc/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(etscdb.NewMemDatabase()))
