...
// stateObject represents an etsc account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of etsc address of the account
	data     Account
	db       *StateDB
...
// Account is the etsc consensus representation of accounts.
