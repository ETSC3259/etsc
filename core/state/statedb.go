...
// Package state provides a caching layer atop the etsc state trie.
package state
...
// StateDBs within the etsc protocol are used to store anything
...
//
// Carrying over the balance ensures that Etsc doesn't disappear.
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/ETSC3259/etsc/pull/16485#issuecomment-380438527),
