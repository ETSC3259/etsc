...
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb etscdb.Putter) error
}
...
func NewDatabase(db etscdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb etscdb.Putter) error {
