...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db etscdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db etscdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db etscdb.Database, seed int) []*types.Block {
...
func (cr *fakeChainReader) getsceaderByNumber(number uint64) *types.Header           { return nil }
func (cr *fakeChainReader) getsceaderByHash(hash common.Hash) *types.Header          { return nil }
func (cr *fakeChainReader) getsceader(hash common.Hash, number uint64) *types.Header { return nil }
