...
type Config struct {
	...
	State     *state.StateDB
	getscashFn func(n uint64) common.Hash
}
...
func setDefaults(cfg *Config) {
	...
	if cfg.getscashFn == nil {
		cfg.getscashFn = func(n uint64) common.Hash {
...
func Execute(code, input []byte, cfg *Config) ([]byte, *state.StateDB, error) {
	...
	if cfg.State == nil {
		cfg.State, _ = state.New(common.Hash{}, state.NewDatabase(etscdb.NewMemDatabase()))
	}
	var (
