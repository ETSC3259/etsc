...
//
// etsc_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// etsc_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.EtscSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "etsc_getBlockByNumber", "latest"); err != nil {
