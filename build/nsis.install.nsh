Name "getsc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ETSC3259/etsc/issues"
!define UPDATEURL "https://github.com/ETSC3259/etsc/releases"
!define ABOUTURL "https://github.com/ETSC3259/etsc#etsc-go"
...
# Install getsc binary
Section "getsc" getsc_IDX
  SetOutPath $INSTDIR
  file {{.getsc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\getsc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\getsc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "getsc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "getsc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "getsc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "getsc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\getsc.exe" "" "" "etsc" 30303 "" "" ""
  SimpleFC::AdvAddRule "getsc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\getsc.exe" "" "" "etsc" "" 30303 "" ""
  SimpleFC::AdvAddRule "getsc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\getsc.exe" "" "" "etsc" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/etsc/EIPs/issues/147)
  ${EnvVarUpdate} $0 "etsc_SOCKET" "R" "HKLM" "\\.\pipe\getsc.ipc"
  ${EnvVarUpdate} $0 "etsc_SOCKET" "A" "HKLM" "\\.\pipe\getsc.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${getsc_IDX}
    SectionGetSize ${getsc_IDX} $0
