...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllEtschashProtocolChanges, new: AllEtschashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllEtschashProtocolChanges, new: AllEtschashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllEtschashProtocolChanges,
