...
import (
	...
	"github.com/ETSC3259/etsc/les/flowcontrol"
...
func testIndexers(db etscdb.Database, odr light.OdrBackend, iConfig *light.IndexerConfig) (*core.ChainIndexer, *core.ChainIndexer, *core.ChainIndexer) {
	chtIndexer := light.NewChtIndexer(db, odr, iConfig.ChtSize, iConfig.ChtConfirms)
	bloomIndexer := etsc.NewBloomIndexer(db, iConfig.BloomSize, iConfig.BloomConfirms)
...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), odr *LesOdr, peers *peerSet, db etscdb.Database) (*ProtocolManager, error) {
	var (
	...
	if lightSync {
		...
		gchain, _ := core.GenerateChain(gspec.Config, genesis, etschash.NewFaker(), db, blocks, generator)
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), odr *LesOdr, peers *peerSet, db etscdb.Database) *ProtocolManager {
...
func newClientServerEnv(t *testing.T, blocks int, protocol int, waitIndexers func(*core.ChainIndexer, *core.ChainIndexer, *core.ChainIndexer), newPeer bool) (*TestEntity, *TestEntity, func()) {
	db, ldb := etscdb.NewMemDatabase(), etscdb.NewMemDatabase()
