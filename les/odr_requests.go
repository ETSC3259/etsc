...
type LesOdrRequest interface {
	...
	Validate(etscdb.Database, *Msg) error
}
...
func (r *BlockRequest) Validate(db etscdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ReceiptsRequest) Validate(db etscdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TrieRequest) Validate(db etscdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *CodeRequest) Validate(db etscdb.Database, msg *Msg) error {
...
func (r *ChtRequest) GetCost(peer *peer) uint64 {
	switch peer.version {
	case lpv1:
		return peer.GetRequestCost(getsceaderProofsMsg, 1)
	case lpv2:
		return peer.GetRequestCost(getscelperTrieProofsMsg, 1)
	default:
		panic(nil)
	}
}
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ChtRequest) Validate(db etscdb.Database, msg *Msg) error {
...
func (r *BloomRequest) GetCost(peer *peer) uint64 {
	return peer.GetRequestCost(getscelperTrieProofsMsg, len(r.SectionIndexList))
}
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *BloomRequest) Validate(db etscdb.Database, msg *Msg) error {
