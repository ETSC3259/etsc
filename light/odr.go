...
type OdrRequest interface {
	StoreResult(db etscdb.Database)
}
...
func (req *TrieRequest) StoreResult(db etscdb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db etscdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db etscdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db etscdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db etscdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db etscdb.Database) {
