...
func TestTxPool(t *testing.T) {
	...
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, etschash.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, etschash.NewFullFaker())
	txPermanent = 50
