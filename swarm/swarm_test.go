...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/getsc.ipc",
			endpoint:    "/data/testnet/getsc.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/getsc.ipc",
			endpoint:    "/data/testnet/getsc.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/getsc.ipc",
			endpoint:    "/data/testnet/getsc.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/getsc.ipc",
			endpoint:    "/data/testnet/getsc.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
		{
			...
			value:       "etsc:314159265dD8dbb310642f98f50C066173C1259b@http://127.0.0.1:1234",
			endpoint:    "http://127.0.0.1:1234",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "etsc",
		},
		{
			...
			value:       "etsc:314159265dD8dbb310642f98f50C066173C1259b@ws://127.0.0.1:1234",
			endpoint:    "ws://127.0.0.1:1234",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "etsc",
		},
...
// https://github.com/etscsphere/go-etsc/issues/639
