...
import (
	...
	"github.com/ETSC3259/etsc/swarm/multihash"
	"github.com/ETSC3259/etsc/swarm/spancontext"
	"github.com/ETSC3259/etsc/swarm/storage"
	"github.com/ETSC3259/etsc/swarm/storage/feed"
	"github.com/ETSC3259/etsc/swarm/storage/feed/lookup"
...
var (
	...
	apigetscTTP300          = metrics.NewRegisteredCounter("api.get.http.300", nil)
...
// ValidateOwner checks the ENS to validate that the owner of the given domain is the given etsc address
...
it is the public interface of the FileStore which is included in the etsc stack
*/
type API struct {
	feed      *feed.Handler
