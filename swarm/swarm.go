...
import (
	...
	"github.com/ETSC3259/etsc/contracts/chequebook"
	"github.com/ETSC3259/etsc/contracts/ens"
	...
	"github.com/ETSC3259/etsc/p2p/protocols"
	"github.com/ETSC3259/etsc/params"
	"github.com/ETSC3259/etsc/rpc"
	"github.com/ETSC3259/etsc/swarm/api"
	httpapi "github.com/ETSC3259/etsc/swarm/api/http"
	"github.com/ETSC3259/etsc/swarm/fuse"
	"github.com/ETSC3259/etsc/swarm/log"
	"github.com/ETSC3259/etsc/swarm/network"
	"github.com/ETSC3259/etsc/swarm/network/stream"
	"github.com/ETSC3259/etsc/swarm/pss"
	"github.com/ETSC3259/etsc/swarm/state"
	"github.com/ETSC3259/etsc/swarm/storage"
	"github.com/ETSC3259/etsc/swarm/storage/feed"
	"github.com/ETSC3259/etsc/swarm/storage/mock"
	"github.com/ETSC3259/etsc/swarm/tracing"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	if config.SwapAPI != "" && config.SwapEnabled {
		...
		backend, err = etscclient.Dial(config.SwapAPI)
		if err != nil {
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config, privkey *ecdsa.PrivateKey) (*ensClient, error) {
	...
	etscClient := etscclient.NewClient(client)
	...
	dns, err := ens.NewENS(transactOpts, ensRoot, etscClient)
	if err != nil {
		return nil, err
	}
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := etscclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
