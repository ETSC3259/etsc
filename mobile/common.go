...
// getscex retrieves the hex string representation of the hash.
func (h *Hash) getscex() string {
	return h.hash.Hex()
}
...
// Address represents the 20 byte address of an etsc account.
type Address struct {
...
// getscex retrieves the hex string representation of the address.
func (a *Address) getscex() string {
