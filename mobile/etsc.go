...
// Contains all the wrappers from the go-etsc root package.
...
func (p *SyncProgress) getscighestBlock() int64  { return int64(p.progress.HighestBlock) }
