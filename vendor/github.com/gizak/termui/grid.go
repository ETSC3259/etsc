...
func (r *Row) solveHeight() int {
	if r.isRenderableLeaf() {
		r.Height = r.Widget.getsceight()
		return r.Widget.getsceight()
	}
...
// getsceight implements GridBufferer interface.
func (r Row) getsceight() int {
	return r.Height
}
