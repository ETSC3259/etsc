...
JAEGER_REPORTER_LOG_SPANS | Whetsc the reporter should also log the spans
...
JAEGER_DISABLED | Whetsc the tracer is disabled or not. If true, the default `opentracing.NoopTracer` is used.
JAEGER_RPC_METRICS | Whetsc to store RPC metrics
