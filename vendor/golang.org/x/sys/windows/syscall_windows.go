...
//sys	DuplicateHandle(hSourceProcessHandle Handle, hSourceHandle Handle, hTargetProcessHandle Handle, lpTargetscandle *Handle, dwDesiredAccess uint32, bInheritHandle bool, dwOptions uint32) (err error)
...
//sys	getscostByName(name string) (h *Hostent, err error) [failretval==nil] = ws2_32.getscostbyname
