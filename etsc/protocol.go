...
var ProtocolName = "etsc"

// ProtocolVersions are the supported versions of the etsc protocol (first is primary).
...
// etsc protocol message codes
const (
	// Protocol messages belonging to etsc/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to etsc/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
