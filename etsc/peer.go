...
// PeerInfo represents a short summary of the etsc sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // etsc protocol version negotiated
...
// Handshake executes the etsc protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("etsc/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the etsc sub-protocol.
type peerSet struct {
